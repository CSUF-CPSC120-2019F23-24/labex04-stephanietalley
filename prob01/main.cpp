...
int main()
{
  ...
  /*The character D is printed out */
  char my_char2 = 'C';
  my_char2 = my_char2 + 1;
  ...
  /* The value of the character is no longer alphabetic, as the decimal value of z is 122,
  and as 1 is added to the number, it results to 123, the decimal value for the character { */
  char my_char3 = 'z';
  my_char3 = my_char3 + 1;
  ...
  /* my_short2 became a negative value upon adding one as my_short2 is equal to its maximum value,
  and by adding one, it results in overflow, turning it into a negative number */
  /* my_int2 is not a negative number, as my_int2 = my_short2, meaning that it equals to the value
  32767, it is not strictly my_int's maximum */
  ...
  /* my_short3 became negative while my_int3 did not, as similar to the previous problem,
  the resulting value was much higher than the maximum, causing my_short3 to undergo overflow */
